...
echo "<p class='cont'> The surviving Autobots escape in separate shuttles, which are shot down by the Decepticons and crash on different planets. Hot Rod and Kup are taken prisoner by the Quintessons, tyrants who hold kangaroo courts and execute prisoners by feeding them to the Sharkticons. Hot Rod and Kup learn of Unicron from Kranix, a lone survivor of Lithone, a planet devoured by Unicron. After Kranix is executed, Hot Rod and Kup escape, aided by the Dinobots and the small Autobot Wheelie, who helps them find an escape ship. </p>";
